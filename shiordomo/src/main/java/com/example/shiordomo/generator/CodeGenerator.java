package com.example.shiordomo.generator;
...
//        gc.setOutputDir("D:\\workspace-sts\\0520adv\\02_mp_springboot/src/main/java");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/2020erp?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("zy85611151");
...
//        pc.setModuleName("sys");
        pc.setParent("com.example.shiordomo");
